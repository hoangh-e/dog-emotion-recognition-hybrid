  ...
  "cells": [
    {
      ...
      "source": [
        "# 🐕 Dog Emotion Recognition - Multi-Model Data Generation & Comparison\n",
        "\n",
        "## 🔄 **Enhanced Pipeline Features:**\n",
        "\n",
        "1. **📊 Multi-Model Support**: Process với nhiều emotion models (Pure34, ResNet50, ResNet101, etc.)\n",
        "2. **🔍 Individual CSV Generation**: Tạo riêng CSV cho từng model\n",
        "3. **⚖️ Model Comparison**: So sánh accuracy, confidence distribution, error analysis\n",
        "4. **📈 Advanced Visualization**: Charts so sánh performance giữa các models\n",
        "5. **🎯 Error Analysis**: Phân tích độ tự tin vào prediction sai\n",
        "\n",
        "## 📋 **Workflow:**\n",
        ...
        "\n",
        "---\n",
        "**🚀 Advanced Features**: Model ensemble comparison, confidence analysis, error profiling\n"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "N34XNTQ5JxOg",
        "outputId": "0383f353-67b0-4a26-862d-d637abfe986d"
      },
      "outputs": [],
      "source": [
        "# ==========================================\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "zHOVEMv9JxOh",
        "outputId": "befa6c05-374e-43b8-a084-001d2b91c670"
      },
      "outputs": [],
      "source": [
        "# ==========================================\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "M1QbH-P2JxOi",
        "outputId": "7f44b22a-3f0d-44c7-865d-d135e7252fa7"
      },
      "outputs": [],
      "source": [
        "# ==========================================\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "vCrBofOPJxOj",
        "outputId": "5242e9de-6c6d-480b-e48d-b0ca5c34095d"
      },
      "outputs": [],
      "source": [
        "# ==========================================\n",
        ...
        "print(f\"🎯 YOLO Tail: {YOLO_TAIL_MODEL}\")\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "aoUBimL_JxOk",
        "outputId": "f62399c0-1890-4624-dde5-609397758f84"
      },
      "outputs": [],
      "source": [
        "# ==========================================\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "eZJALNzaJxOl",
        "outputId": "2802ac63-f4d6-4483-fce8-8325c9c066f1"
      },
      "outputs": [],
      "source": [
        "# ==========================================\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "vX33NJyyJxOm",
        "outputId": "a6124a14-b009-4a62-e887-b57601f4960d"
      },
      "outputs": [],
      "source": [
        "# ==========================================\n",
        ...
        "            # loaded_models[model_name] = model\n",
        "            # model_transforms[model_name] = transform\n",
        "            print(f\"⚠️ {model_name} ResNet loading not implemented yet\")\n",
        "\n",
        "        else:\n",
        ...
        "else:\n",
        "    print(f\"✅ Multi-model mode active with {len(loaded_models)} models\")\n",
        "\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "zp6N-x1AJxOm",
        "outputId": "7d831939-ba65-4fc4-d868-5b19177aed14"
      },
      "outputs": [],
      "source": [
        "# ==========================================\n",
        ...
        "    \"\"\"🎯 Predict dog tail status using YOLO with duplicate class handling\"\"\"\n",
        "    try:\n",
        "        results = model(image_path, verbose=False)\n",
        ...
        "\n",
        "print(\"✅ YOLO prediction functions defined\")\n"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "Lw5dGc1FJxOn",
        "outputId": "75ea4303-d621-4950-c04e-8b60fbf90274"
      },
      "outputs": [],
      "source": [
        "# ==========================================\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "d9P0TRAxJxOo",
        "outputId": "cffa5eaf-0af2-4313-b80f-43d431871daf"
      },
      "outputs": [],
      "source": [
        "# ==========================================\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "w0V-IZvKJxOo",
        "outputId": "c195d0cf-a7a2-46d0-8bd1-8f2b87239a88"
      },
      "outputs": [],
      "source": [
        "# ==========================================\n",
        ...
        "# ==========================================\n",
        "\n",
        "print(\"🔄 Starting multi-model processing pipeline...\")\n",
        "print(\"=\" * 60)\n",
        "\n",
        ...
        "            skipped_count += 1\n",
        "            if i <= 3:\n",
        "                print(f\"   ⚠️  Skipped {image_path.name}: ALL EMOTION predictions failed\")\n",
        "            continue\n",
        "\n",
        "        # 6. Get manual label\n",
        ...
        "\n",
        "        # 7. ✅ SUCCESS: Compile results for each model\n",
        "        for model_name, emotion_result in emotion_results.items():\n",
        "            if emotion_result.get('predicted', False):\n",
        "                row = {\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "7B_VvA7AJxOo",
        "outputId": "11af40a9-c3f4-4978-d611-6e82057f615f"
      },
      "outputs": [],
      "source": [
        "# ==========================================\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "Qq93A6wnJxOp",
        "outputId": "371f2909-298c-4d52-862d-bb3d49b1743f"
      },
      "outputs": [],
      "source": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "M19qkH7gJxOp",
        "outputId": "eff161a7-0c82-4630-c5d5-30f92842e42f"
      },
      "outputs": [],
      "source": [
        "# ==========================================\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "0O9Sf2rsJxOp",
        "outputId": "15b69c17-9763-4bcd-f613-163b2165266d"
      },
      "outputs": [],
      "source": [
        "# ==========================================\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "swLU9IQ3JxOq",
        "outputId": "fa60c01a-3f8e-4980-a2ec-53f3f095fb6f"
      },
      "outputs": [],
      "source": [
        "# ==========================================\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "SDN-hqI3JxOq",
        "outputId": "53c5c9f1-c54a-4b33-a186-3016992a22be"
      },
      "outputs": [],
      "source": [
        "# ==========================================\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "bXkD47TGJxOq",
        "outputId": "26f922d7-03b3-4c70-9df5-e6697fb1e3d2"
      },
      "outputs": [],
      "source": [
        "# ==========================================\n",
